...
namespace EnviaTest
{
    public partial class AdminUsuario : Form
    {
        ...
        {
            this.Hide();
            var CPanelInstance = Application.OpenForms.OfType<Panel_Envia>().Single();
            CPanelInstance.Show();
        }
        ...
        {
            DialogResult dialogResult = MessageBox.Show("Borrar el usuario Envia permanente?", "Confirmar", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void deleteUser()
        {
            ...
            conn.Close();
            DGV_GetUsers();
            CSTool.infoMessage("EL registro de usuario envia ha sido borrado.");
        }

        private void btn_add_Click(object sender, EventArgs e)
        {
            new AgregarUsuario().ShowDialog();
        }
    }
}
